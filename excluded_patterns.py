...
#
#   "target :: marker" matches target only when marker exists in target's
...
#   "target/ :: Cargo.toml" excludes a Cargo target directory.
#   ".venv/ :: pyproject.toml + uv.lock" requires both marker files.
#
